...
# Run GA experiment
from libs.ga.ga_experiments import RowShuffle_c0layer_lenet_3hidden_ERRexpbitflips
...
for i in range(K):
    ...
    experiment = RowShuffle_c0layer_lenet_3hidden_ERRexpbitflips(   model=model,
