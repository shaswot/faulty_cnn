...
log_folder='/work/gq50/q50002/faulty_cnn/logfiles/all/mnist32-cnn/'${exp_name}
mkdir -p ${log_folder}
...
cd /work/gq50/q50002/faulty_cnn/ga_scripts/all/mnist32-cnn/

singularity exec \
	--bind `pwd` \
	-H /work/gq50/q50002/faulty_cnn\
	/work/gq50/q50002/faulty_cnn_san.file \
    python ${exp_name}.py ${model_instance} ${error_lim}-3987 > ${log_folder}/${model_instance}--${error_lim}-3987".log" 
